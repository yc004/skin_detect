...
\begin{figure}[H]
    \centering
    \includegraphics[height=0.55\textheight]{img/model_baseline.png}
    \hfill
    \includegraphics[height=0.55\textheight]{img/model_improve.png}
    \caption{模型架构对比（左：基线 ConvNeXt V1 + AvgPool；右：改进 ConvNeXt V2 + GeM + EMA。红框标注 GRN 层，蓝框标注 GeM Pooling）}
