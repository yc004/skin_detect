...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\textwidth]{../runs/convnext_tiny/confusion_matrix.png}
    \par\vspace{8pt}
    \includegraphics[width=0.75\textwidth]{../runs/convnextv2_tiny_GeM_EMA/confusion_matrix.png}
    \caption{验证集混淆矩阵对比（上：基线模型，下：改进模型）}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\textwidth]{../runs/convnext_tiny/roc_curves.png}
    \par\vspace{8pt}
    \includegraphics[width=0.75\textwidth]{../runs/convnextv2_tiny_GeM_EMA/roc_curves.png}
    \caption{One-vs-Rest ROC 曲线对比（上：基线 Micro AUC=0.974，下：改进 Micro AUC=0.982）}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\textwidth]{../runs/convnext_tiny/per_class_metrics.png}
    \par\vspace{8pt}
    \includegraphics[width=0.75\textwidth]{../runs/convnextv2_tiny_GeM_EMA/per_class_metrics.png}
    \caption{Per-Class Precision/Recall/F1 指标对比（上：基线模型，下：改进模型）}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\textwidth]{../runs/convnext_tiny/confusion_matrix_test.png}
    \par\vspace{8pt}
    \includegraphics[width=0.75\textwidth]{../runs/convnextv2_tiny_GeM_EMA/confusion_matrix_test.png}
    \caption{测试集混淆矩阵对比（上：基线模型，下：改进模型）}
    \label{fig:test_confusion_comparison}
\end{figure}
